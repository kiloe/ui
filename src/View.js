...
export default class View extends React.Component {
  ...
  // an active modal. This method is only accessed on the rootView.
  onClickOutside(){
  ...
  // cause the element to be rendered as a child of the rootView.
  ...
  render(children) {
    ...
    // if we are the rootView then we might need to
